...
class Race(Settings):
    ...
    def calc_race(self):
        """
        Расчет времени забега для каждого спортсмена. Метод получает номера 
    ...
    def show_race(self):
        """
        Выводит итоговую таблицу с временем забега каждого спортсмена в 
        консоль.
        arg: None
        return: None
        """
    ...
    def save_race(self):
        """
        Сохраняет итоговую таблицу с временем забега каждого спортсмена в файл.
        arg: None
        return: None
        """
