...
class Results(Settings):
    ...
    def parse_results_file(self):
        """
        Чтение файла с результатами забега и его парсинг.
    ...
    def calc_results(self):
        """
        Метод сортирует результаты забега и возвращает словарь, в котором
        ключи - места занятые спортсменами в порядке возрастания, а значения
        ключей - данные о спортсменах и время забега.
        arg: None
        return: None
        """
