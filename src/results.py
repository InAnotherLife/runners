...
class Results(Settings):
    ...
    def parse_results_file(self):
        ...
        следующие действия: чтение двух строк и разбиение их на отдельные
        элементы, проверка строк на валидность, получение номера спортсмена,
        вычисление времени забега спортсмена. Метод возвращает список словарей
        с данными спортсменов. Если происходит ошибка, то выбрасывается
        исключение.
        arg: None
        return: List
        """
    ...
    def calc_results(self):
        """
        Сортировка результатов забега по времени. Метод возвращает словарь,
